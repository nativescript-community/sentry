declare namespace io {
    export namespace sentry {
        export class DefaultSentryClientFactory extends SentryClientFactory {
            ...
            public getBufferedConnectionGracefulShutdownEnabled(param0: dsn.Dsn): boolean;
            public getSampleRate(param0: dsn.Dsn): java.lang.Double;
            public getRejectedExecutionHandler(param0: dsn.Dsn): java.util.concurrent.RejectedExecutionHandler;
            public getUncaughtHandlerEnabled(param0: dsn.Dsn): boolean;
            public getProxyPort(param0: dsn.Dsn): number;
            public getRelease(param0: dsn.Dsn): string;
            public getAsyncPriority(param0: dsn.Dsn): number;
            public getBuffer(param0: dsn.Dsn): buffer.Buffer;
            public getBufferSize(param0: dsn.Dsn): number;
            public createMarshaller(param0: dsn.Dsn): marshaller.Marshaller;
            public getBufferedConnectionShutdownTimeout(param0: dsn.Dsn): number;
            public getMdcTags(param0: dsn.Dsn): java.util.Set<any>;
            public getServerName(param0: dsn.Dsn): string;
            public createStdOutConnection(param0: dsn.Dsn): connection.Connection;
            public getAsyncEnabled(param0: dsn.Dsn): boolean;
            public getExtraTags(param0: dsn.Dsn): java.util.Set<any>;
            public getBufferEnabled(param0: dsn.Dsn): boolean;
            public getAsyncThreads(param0: dsn.Dsn): number;
            public getAsyncGracefulShutdownEnabled(param0: dsn.Dsn): boolean;
            public getProxyHost(param0: dsn.Dsn): string;
            public getInAppFrames(param0: dsn.Dsn): java.util.Collection<any>;
            public getHideCommonFramesEnabled(param0: dsn.Dsn): boolean;
            public getBypassSecurityEnabled(param0: dsn.Dsn): boolean;
            public getAsyncShutdownTimeout(param0: dsn.Dsn): number;
            public getExtra(param0: dsn.Dsn): java.util.Map<any, any>;
            public getCompressionEnabled(param0: dsn.Dsn): boolean;
            public constructor();
            public createSentryClient(param0: dsn.Dsn): SentryClient;
            public getAsyncQueueSize(param0: dsn.Dsn): number;
            public getContextManager(param0: dsn.Dsn): context.ContextManager;
            public getProxyUser(param0: dsn.Dsn): string;
            public getTimeout(param0: dsn.Dsn): number;
            public createAsyncConnection(param0: dsn.Dsn, param1: connection.Connection): connection.Connection;
            public createHttpConnection(param0: dsn.Dsn): connection.Connection;
            public getProxyPass(param0: dsn.Dsn): string;
            public createConnection(param0: dsn.Dsn): connection.Connection;
            public getDist(param0: dsn.Dsn): string;
            public configureSentryClient(param0: SentryClient, param1: dsn.Dsn): SentryClient;
            public getEnvironment(param0: dsn.Dsn): string;
            public getBufferFlushtime(param0: dsn.Dsn): number;
            public getTags(param0: dsn.Dsn): java.util.Map<any, any>;
            public getMaxMessageLength(param0: dsn.Dsn): number;
        }
        export namespace DefaultSentryClientFactory {
...
declare namespace io {
    export namespace sentry {
        export class Sentry {
            public static setStoredClient(param0: SentryClient): void;
            public static capture(param0: event.Event): void;
            public static record(param0: event.Breadcrumb): void;
            public static setUser(param0: event.User): void;
            public static init(): SentryClient;
            public static capture(param0: event.EventBuilder): void;
            public static getContext(): context.Context;
            public static capture(param0: string): void;
            public static init(param0: string, param1: SentryClientFactory): SentryClient;
            public static close(): void;
            public static clearContext(): void;
            public static init(param0: SentryClientFactory): SentryClient;
            public static getStoredClient(): SentryClient;
            public static capture(param0: java.lang.Throwable): void;
            public static init(param0: string): SentryClient;
        }
    }
}
...
declare namespace io {
    export namespace sentry {
        export class SentryClient {
            ...
            public sendEvent(param0: event.EventBuilder): void;
            public constructor(param0: connection.Connection, param1: context.ContextManager);
            ...
            public addBuilderHelper(param0: event.helper.EventBuilderHelper): void;
            public addEventSendCallback(param0: connection.EventSendCallback): void;
...
declare namespace io {
    export namespace sentry {
        export abstract class SentryClientFactory {
            ...
            public toString(): string;
            public static sentryClient(param0: string): SentryClient;
            public constructor();
            public static sentryClient(param0: string, param1: SentryClientFactory): SentryClient;
            public createSentryClient(param0: dsn.Dsn): SentryClient;
        }
    }
}
...
declare namespace io {
    export namespace sentry {
        export class SentryUncaughtExceptionHandler {
            ...
            public static setup(): SentryUncaughtExceptionHandler;
        }
    }
}
...
declare namespace io {
    export namespace sentry {
        export namespace android {
            export class AndroidSentryClientFactory extends DefaultSentryClientFactory {
            ...
            export namespace event {
                export namespace helper {
                    export class AndroidEventBuilderHelper {
                        public static TAG: string;
                        public helpBuildingEvent(param0: sentry.event.EventBuilder): void;
                        public constructor(param0: any /* android.content.Context */);
                    }
                }
            }
    ...
    export namespace sentry {
        export namespace buffer {
            export class Buffer {
                 ...
                 */
                public constructor(implementation: { add(param0: event.Event): void; discard(param0: event.Event): void; getEvents(): java.util.Iterator<any> });
                public discard(param0: event.Event): void;
                public getEvents(): java.util.Iterator<any>;
                public add(param0: event.Event): void;
            }
        }
    }
}
    ...
    export namespace sentry {
        export namespace config {
            export class Lookup {
                ...
                public static lookup(param0: string, param1: dsn.Dsn): string;
            }
        }
    }
}
    ...
    export namespace sentry {
        export namespace connection {
            export abstract class AbstractConnection {
                ...
                public doSend(param0: event.Event): void;
                public addEventSendCallback(param0: EventSendCallback): void;
                public getAuthHeader(): string;
                public constructor(param0: string, param1: string);
                public send(param0: event.Event): void;
            }
        }
    }
}
    ...
    export namespace sentry {
        export namespace connection {
            export class AsyncConnection {
                public close(): void;
                public addEventSendCallback(param0: EventSendCallback): void;
                public constructor(param0: Connection, param1: java.util.concurrent.ExecutorService, param2: boolean, param3: number);
                public send(param0: event.Event): void;
            }
    ...
    export namespace sentry {
        export namespace connection {
            export class BufferedConnection {
                public close(): void;
                public addEventSendCallback(param0: EventSendCallback): void;
                public wrapConnectionWithBufferWriter(param0: Connection): Connection;
                public constructor(param0: Connection, param1: buffer.Buffer, param2: number, param3: boolean, param4: number);
                public send(param0: event.Event): void;
            }
            export namespace BufferedConnection {
    ...
    export namespace sentry {
        export namespace connection {
            export class Connection {
                 ...
                 */
                public constructor(implementation: { send(param0: event.Event): void; addEventSendCallback(param0: EventSendCallback): void });
                public addEventSendCallback(param0: EventSendCallback): void;
                public send(param0: event.Event): void;
            }
        }
    ...
    export namespace sentry {
        export namespace connection {
            export class EventSampler {
                 ...
                 */
                public constructor(implementation: { shouldSendEvent(param0: event.Event): boolean });
                public shouldSendEvent(param0: event.Event): boolean;
            }
        }
    }
}
    ...
    export namespace sentry {
        export namespace connection {
            export class EventSendCallback {
                 ...
                 */
                public constructor(implementation: { onFailure(param0: event.Event, param1: java.lang.Exception): void; onSuccess(param0: event.Event): void });
                public onFailure(param0: event.Event, param1: java.lang.Exception): void;
                public onSuccess(param0: event.Event): void;
            }
        }
    }
}
    ...
    export namespace sentry {
        export namespace connection {
            export class HttpConnection extends AbstractConnection {
                public doSend(param0: event.Event): void;
                public setMarshaller(param0: marshaller.Marshaller): void;
                public close(): void;
                ...
                public constructor(param0: java.net.URL, param1: string, param2: string, param3: java.net.Proxy, param4: EventSampler);
                public constructor(param0: string, param1: string);
                public send(param0: event.Event): void;
            }
        }
    ...
    export namespace sentry {
        export namespace connection {
            export class LockdownManager {
                ...
                public setState(param0: ConnectionException): void;
                public setMaxLockdownTime(param0: number): void;
                public constructor(param0: time.Clock);
...
declare namespace io {
    export namespace sentry {
        export namespace connection {
            export class NoopConnection extends AbstractConnection {
                public doSend(param0: event.Event): void;
                public close(): void;
                public addEventSendCallback(param0: EventSendCallback): void;
                public constructor(param0: string, param1: string);
...
declare namespace io {
    export namespace sentry {
        export namespace connection {
            export class OutputStreamConnection extends AbstractConnection {
    ...
    export namespace sentry {
        export namespace context {
            export class Context {
                ...
                public setUser(param0: event.User): void;
                public clearUser(): void;
                public recordBreadcrumb(param0: event.Breadcrumb): void;
            }
        }
    }
}
    ...
    export namespace sentry {
        export namespace context {
            export class ContextManager {
                 ...
                 */
                public constructor(implementation: { getContext(): Context; clear(): void });
    ...
    export namespace sentry {
        export namespace event {
            export class Breadcrumb {
                public getType(): Breadcrumb.Type;
                public getLevel(): Breadcrumb.Level;
            ...
            export namespace Breadcrumb {
                export class Level {
                    public static DEBUG: Level;
                    public static INFO: Level;
                    public static WARNING: Level;
                    public static ERROR: Level;
                    public static CRITICAL: Level;
                    public static valueOf(param0: string): Level;
                    public getValue(): string;
                    public static values(): native.Array<Level>;
                }
                export class Type {
                    public static DEFAULT: Type;
                    public static HTTP: Type;
                    public static NAVIGATION: Type;
    ...
    export namespace sentry {
        export namespace event {
            export class BreadcrumbBuilder {
                public setLevel(param0: Breadcrumb.Level): BreadcrumbBuilder;
                public setData(param0: java.util.Map<any, any>): BreadcrumbBuilder;
                public build(): Breadcrumb;
                public setMessage(param0: string): BreadcrumbBuilder;
                public setType(param0: Breadcrumb.Type): BreadcrumbBuilder;
                public setTimestamp(param0: java.util.Date): BreadcrumbBuilder;
                public setCategory(param0: string): BreadcrumbBuilder;
                public constructor();
            }
        }
    }
    ...
    export namespace sentry {
        export namespace event {
            export class EventBuilder {
                ...
                public withFingerprint(param0: native.Array<string>): EventBuilder;
                public withEnvironment(param0: string): EventBuilder;
                public build(): Event;
                public withLevel(param0: Event.Level): EventBuilder;
                public withLogger(param0: string): EventBuilder;
                public constructor();
                public withContexts(param0: java.util.Map<any, any>): EventBuilder;
                public getEvent(): Event;
                public withSentryInterface(param0: interfaces.SentryInterface, param1: boolean): EventBuilder;
                public withTag(param0: string, param1: string): EventBuilder;
                public withCulprit(param0: string): EventBuilder;
                public withPlatform(param0: string): EventBuilder;
                public withTimestamp(param0: java.util.Date): EventBuilder;
                public withChecksum(param0: string): EventBuilder;
                public withCulprit(param0: java.lang.StackTraceElement): EventBuilder;
                public withFingerprint(param0: java.util.List<any>): EventBuilder;
                public withSdkIntegration(param0: string): EventBuilder;
                public withDist(param0: string): EventBuilder;
                public withExtra(param0: string, param1: java.lang.Object): EventBuilder;
                public withBreadcrumbs(param0: java.util.List<any>): EventBuilder;
                public withServerName(param0: string): EventBuilder;
                public withTransaction(param0: string): EventBuilder;
                public constructor(param0: java.util.UUID);
                public toString(): string;
                public withSentryInterface(param0: interfaces.SentryInterface): EventBuilder;
                public withMessage(param0: string): EventBuilder;
                public withRelease(param0: string): EventBuilder;
                public withCulprit(param0: interfaces.SentryStackTraceElement): EventBuilder;
                public withChecksumFor(param0: string): EventBuilder;
            }
            export namespace EventBuilder {
    ...
    export namespace sentry {
        export namespace event {
            export class UserBuilder {
                public setIpAddress(param0: string): UserBuilder;
                public build(): User;
                public setId(param0: string): UserBuilder;
                public setUsername(param0: string): UserBuilder;
                public setEmail(param0: string): UserBuilder;
                public constructor();
                public setData(param0: java.util.Map<any, any>): UserBuilder;
                public withData(param0: string, param1: java.lang.Object): UserBuilder;
            }
        }
    }
}
        ...
        export namespace event {
            export namespace helper {
                export class ContextBuilderHelper {
                    public constructor(param0: SentryClient);
                    public helpBuildingEvent(param0: EventBuilder): void;
                }
            }
        }
    }
        ...
        export namespace event {
            export namespace helper {
                export class EventBuilderHelper {
                     ...
                     */
                    public constructor(implementation: { helpBuildingEvent(param0: EventBuilder): void });
                    public helpBuildingEvent(param0: EventBuilder): void;
                }
            }
        }
        ...
        export namespace event {
            export namespace helper {
                export class HttpEventBuilderHelper {
                    public constructor(param0: RemoteAddressResolver);
                    public constructor();
                    public getRemoteAddressResolver(): RemoteAddressResolver;
                    public helpBuildingEvent(param0: EventBuilder): void;
                }
            }
        }
        ...
        export namespace event {
            export namespace helper {
                export class RemoteAddressResolver {
                     ...
                     */
                    public constructor(implementation: { getRemoteAddress(param0: any /* javax.servlet.http.HttpServletRequest */): string });
                    public getRemoteAddress(param0: any /* javax.servlet.http.HttpServletRequest */): string;
                }
            }
        }
        ...
        export namespace event {
            export namespace helper {
                export class ShouldSendEventCallback {
                     ...
                     */
                    public constructor(implementation: { shouldSend(param0: Event): boolean });
                    public shouldSend(param0: Event): boolean;
                }
            }
        }
    }
        ...
        export namespace event {
            export namespace interfaces {
                export class DebugMetaInterface {
                    ...
                    public addDebugImage(param0: DebugMetaInterface.DebugImage): void;
                    public toString(): string;
                    public constructor();
                    public getInterfaceName(): string;
                    public hashCode(): number;
                }
                export namespace DebugMetaInterface {
        ...
        export namespace event {
            export namespace interfaces {
                export class HttpInterface {
                    ...
                    public constructor(param0: any /* javaxservlethttpHttpServletRequest */, param1: helper.RemoteAddressResolver);
                    public getProtocol(): string;
                    ...
                    public constructor(param0: any /* javaxservlethttpHttpServletRequest */, param1: helper.RemoteAddressResolver, param2: string);
        ...
        export namespace event {
            export namespace interfaces {
                export class SentryException {
                    ...
                    public getStackTraceInterface(): StackTraceInterface;
                    public equals(param0: java.lang.Object): boolean;
                    public constructor(param0: string, param1: string, param2: string, param3: StackTraceInterface);
        ...
        export namespace event {
            export namespace interfaces {
                export class SentryStackTraceElement {
                    ...
                    public static fromStackTraceElements(param0: native.Array<java.lang.StackTraceElement>): native.Array<SentryStackTraceElement>;
                    public toString(): string;
                    ...
                    public static fromStackTraceElements(
                        ...
                        param1: native.Array<jvmti.Frame>
                    ): native.Array<SentryStackTraceElement>;
                    public static fromStackTraceElement(param0: java.lang.StackTraceElement): SentryStackTraceElement;
                    public hashCode(): number;
                }
            }
        }
        ...
        export namespace event {
            export namespace interfaces {
                export class StackTraceInterface {
                    ...
                    public getStackTrace(): native.Array<SentryStackTraceElement>;
                    public toString(): string;
                    public constructor(param0: native.Array<java.lang.StackTraceElement>, param1: native.Array<java.lang.StackTraceElement>);
                    public constructor(param0: native.Array<java.lang.StackTraceElement>, param1: native.Array<java.lang.StackTraceElement>, param2: native.Array<jvmti.Frame>);
                    public equals(param0: java.lang.Object): boolean;
                    public getInterfaceName(): string;
                    public getFramesCommonWithEnclosing(): number;
                    public hashCode(): number;
                    public constructor(param0: native.Array<java.lang.StackTraceElement>);
                    public constructor(param0: native.Array<SentryStackTraceElement>);
                }
            }
        }
    }
    ...
    export namespace sentry {
        export namespace jul {
            export class SentryHandler {
                ...
                public createEventBuilder(param0: java.util.logging.LogRecord): event.EventBuilder;
                public static getLevel(param0: java.util.logging.Level): event.Event.Level;
            ...
            export namespace SentryHandler {
...
declare namespace io {
    export namespace sentry {
        export namespace jvmti {
            export class Frame {
                public getLocals(): java.util.Map<any, any>;
                public constructor(param0: java.lang.reflect.Method, param1: native.Array<Frame.LocalVariable>);
    ...
    export namespace sentry {
        export namespace jvmti {
            export class FrameCache {
                ...
                public static add(param0: java.lang.Throwable, param1: native.Array<Frame>): void;
                public static shouldCacheThrowable(param0: java.lang.Throwable, param1: number): boolean;
                public static get(param0: java.lang.Throwable): native.Array<Frame>;
            }
        }
    }
}
    ...
    export namespace sentry {
        export namespace marshaller {
            export class Marshaller {
                 ...
                 */
                public constructor(implementation: { marshall(param0: event.Event, param1: java.io.OutputStream): void; getContentType(): string; getContentEncoding(): string });
                public getContentType(): string;
                public marshall(param0: event.Event, param1: java.io.OutputStream): void;
        ...
        export namespace marshaller {
            export namespace json {
                export class DebugMetaInterfaceBinding {
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.SentryInterface): void;
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.DebugMetaInterface): void;
                    public constructor();
                }
            }
        }
        ...
        export namespace marshaller {
            export namespace json {
                export class ExceptionInterfaceBinding {
                    public constructor(param0: InterfaceBinding);
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.SentryInterface): void;
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.ExceptionInterface): void;
                }
            }
        }
    }
        ...
        export namespace marshaller {
            export namespace json {
                export class HttpInterfaceBinding {
                    ...
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.SentryInterface): void;
                    public constructor();
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.HttpInterface): void;
                }
            }
        }
    }
        ...
        export namespace marshaller {
            export namespace json {
                export class InterfaceBinding {
                     ...
                     */
                    public constructor(implementation: { writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.SentryInterface): void });
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.SentryInterface): void;
                }
            }
        }
        ...
        export namespace marshaller {
            export namespace json {
                export class JsonMarshaller {
                    ...
                    public marshall(param0: event.Event, param1: java.io.OutputStream): void;
                    public getContentType(): string;
                    public addInterfaceBinding(param0: java.lang.Class<any>, param1: InterfaceBinding): void;
                    public constructor(param0: number);
                }
            }
        }
        ...
        export namespace marshaller {
            export namespace json {
                export class MessageInterfaceBinding {
                    ...
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.SentryInterface): void;
                    public constructor();
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.MessageInterface): void;
                    public constructor(param0: number);
                }
            }
        }
        ...
        export namespace marshaller {
            export namespace json {
                export class StackTraceInterfaceBinding {
                    ...
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.StackTraceInterface): void;
                    public constructor();
                }
            }
        }
        ...
        export namespace marshaller {
            export namespace json {
                export class UserInterfaceBinding {
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.SentryInterface): void;
                    public constructor();
                    public writeInterface(param0: any /* com.fasterxml.jackson.core.JsonGenerator */, param1: event.interfaces.UserInterface): void;
                }
            }
        }
    }
